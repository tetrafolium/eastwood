...
(defn indexing-reader?
  ...
  [rdr]
  (or (instance? eastwood.copieddeps.dep10.clojure.tools.reader.reader_types.IndexingReader rdr)
      (instance? LineNumberingPushbackReader rdr)
      (and (not (instance? eastwood.copieddeps.dep10.clojure.tools.reader.reader_types.PushbackReader rdr))
           (not (instance? eastwood.copieddeps.dep10.clojure.tools.reader.reader_types.StringReader rdr))
           (not (instance? eastwood.copieddeps.dep10.clojure.tools.reader.reader_types.InputStreamReader rdr))
